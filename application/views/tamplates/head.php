...
<head>
    ...
    <meta name="keywords" content="<?php echo $keyword_pencarian ?>">
    <meta name="author" content="Oneira Web Developer">
...
<body class="body">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <img class="logo-img" src="./assets/img/logo.png" height="100" alt="">
            </div>
        </div>
    </div>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#"><?php echo $judul_page ?></a>
